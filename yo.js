...
Insider.__external.CreateMemoryGame159520 = (idConfig) => {
    ...
    const config = {
        formData: {
            nameAndSurnameId: '17253700854170',
            phoneId: '15454057406530',
            emailId: '15452221711090',
            gdprId: '16554144661620',
            couponId: '1545222259340', /* OPT-161916 */
        },
        /* Close Button */
    ...
    self.setEvents = () => {
        ...
        Insider.eventManager.once(`click.start:game:${ variationId }`, startButton, () => {
            ...
            if (nameAndSurname && isValidPhone && gdpr && isValidEmail) { /* OPT-167483 */
    ...
    self.sendLeadCollection = (inputs) => {
        ...
        let formattedPhone = phone[0] === '0' ? phone.slice(1, 10).trim() : phone;
                ...
                options: [
                    {
                        ...
                        text: gdpr.toString(),
                        type: 'checkbox',
                        inputType: 'lead-collection-opt-in'
                    }
                ],
                questionId: gdprId
            }
        ...
        if (phone) {
            Insider.request.post({
                ...
                parse: true,
                success: () => {
                    Insider.utils.opt.sendCustomGoal(currentBuilderId, 138, true);
