...
((self) => {
    ...
    self.checkList = (productIds) => {
        const requestData = {
            ...
            lists: {
                productList_OPT153681: productIds /* OPT-157171 */
            }
        };
        ...
        Insider.request.post({
            ...
            success: (response) => {
                if (response.success === true) {
                    if (response.data['productList_OPT153681']?.length > 0) { /* OPT-157171 */
                        if (!isControlGroup) {
                            self.reset();
                            self.buildCSS();
                            self.buildHTML(response.data['productList_OPT153681']); /* OPT-157171 */
                        }
