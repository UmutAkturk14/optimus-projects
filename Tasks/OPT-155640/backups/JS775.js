const COMMON = {
    ...
    maxResultCount: Number('#{{Rows}}') * Number('#{{Columns}}'),
};
...
const templateConfig = {
    CONFIG: {
        ...
        campaign: camp,
        maxResultCount: COMMON.maxResultCount,
        ...
        isPaginationActive: '#{{Product Showcase}}' === 'pagination',
        isLoadMoreActive: '#{{Product Showcase}}' === 'load more',
    ...
    ELEMENTS: {
        ...
        notificationContent: `${ COMMON.eurekaMainWrapperSelector } .ins-notification-content`,
        ...
        sortButton: '.ins-sort-container .ins-dropdown-container .ins-dropdown-button',
        itemsPerPageButton: '.ins-items-per-page .ins-dropdown-container .ins-dropdown-button',
        dropdownButton: '.ins-dropdown-button',
        sortingDropdownWrapper: '.ins-sort-container .ins-dropdown-wrapper',
        itemsPerPageDropdownWrapper: '.ins-items-per-page .ins-dropdown-wrapper',
        dropdownItem: '.ins-dropdown-item',
        dropdownText: '.ins-dropdown-text',
        sortDropdownItem: '.ins-sort-container .ins-dropdown-item',
        itemsPerPageDropdownItem: '.ins-items-per-page .ins-dropdown-item',
        facetSearch: '.ins-facet-search-input',
        appliedFiltersContainer: '.ins-sidebar-applied-filters',
        appliedFilterChip: '.ins-sidebar-applied-filters .ins-facet-checkbox-chip',
        ...
        redirectionWrapper: '.ins-section-redirection-wrapper',
        ...
        noResultTextContainer: '.no-result-text-container .ins-editable-text',
        ...
        resultListButton: '#ins-slide-page-1 .ins-facet-item-list',
        ...
        range: '[data-ins-facet-style="range"] span.ins-editable',
    },
    ATTRIBUTES: {
    ...
    EVENTS: {
        ...
        searchInputPaste: `paste.ins:eureka:search:input:${ camp.id }`,
        ...
        windowScroll: `scroll.ins:eureka:window:scroll:${ camp.id }`,
