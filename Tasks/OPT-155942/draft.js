...
const getCategoryKeys = (referrer) => {
...
const handleAfterPaymentPage = () => {
    ...
    removeUnusedStorages(filteredStorage);
};

const removeUnusedStorages = (filteredStorage) => {
...
const handleProductPage = (categoryKeys, referrer) => {
...
const categoryKeys = getCategoryKeys(referrer);

if (Insider.systemRules.call('isOnAfterPaymentPage')) {
    handleAfterPaymentPage();
} else if (Insider.systemRules.call('isOnProductPage')) {
    handleProductPage(categoryKeys, referrer);
}
