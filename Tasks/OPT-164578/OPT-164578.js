...
((self) => {
    ...
    self.setCampaign = () => {
        ...
        $products.accessNodes((node) => {
            ...
            if (configuratorUrls.some(self.matchProduct)) {
                const matchedProduct = configuratorUrls.find(self.matchProduct(productPageLink));
    ...
    self.matchProduct = (pageLink) => (product) => product.urlKey === pageLink;
