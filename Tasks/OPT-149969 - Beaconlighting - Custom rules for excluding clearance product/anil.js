...
((self) => {
  ...
  self.checkEligibilityProduct = () => {
      ...
      return (isOnProductPage && !SKUs.has(Insider.systemRules.call('getCurrentProduct').id)) || (!isOnClearancePage && Insider.systemRules.call('isOnCategoryPage'));
  };
  /* OPT149969 END */
  ...
  self.setEvents = () => {
      ...
      Insider.eventManager.once('click.add:to:cart:click', selectors.addToCart, () => {
          Insider.utils.opt.sendCustomGoal(builderId, 270, true);
      });
  };
